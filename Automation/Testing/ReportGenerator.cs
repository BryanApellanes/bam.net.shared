...
namespace Bam.Net.Automation.Testing
{
    public class ReportGenerator
    {
        ...
        {
            DirectoryInfo coverageFolder = new DirectoryInfo(System.IO.Path.Combine(BamHome.Tests, TestConstants.CoverageXmlFolder));
            ...
            return Run(outputDirectoryPath, reportXmlFilePaths, System.IO.Path.Combine(BamHome.Tests, TestConstants.HistoryFolder));
        }
        ...
        private static string GetCommand(string outputDirectoryPath, string historyDirectoryPath = null)
        {
            ...
            historyDirectoryPath = historyDirectoryPath ?? System.IO.Path.Combine(BamHome.Tests, "CoverageHistory");
