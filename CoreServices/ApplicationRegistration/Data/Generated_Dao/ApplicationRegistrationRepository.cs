...
namespace Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Repository
{
	...
	public class ApplicationRegistrationRepository: DaoRepository
	{
		public ApplicationRegistrationRepository()
		{
			...
			AddType<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>();
		...
		/// of the specified columns.
		/// </summary>
		public void SetOneApiKeyWhere(WhereDelegate<ApiKeyColumns> where, out Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey result)
		{
			...
			result = daoResult.CopyAs<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>();
		}
		...
		/// </summary>
		/// <param name="where"></param>
		public Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey GetOneApiKeyWhere(WhereDelegate<ApiKeyColumns> where)
		{
			Type wrapperType = GetWrapperType<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>();
			return (Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey)Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.ApiKey.GetOneWhere(where, Database)?.CopyAs(wrapperType, this);
		}
		...
		/// </param>
		public Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey OneApiKeyWhere(WhereDelegate<ApiKeyColumns> where)
        {
            Type wrapperType = GetWrapperType<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>();
            return (Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey)Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.ApiKey.OneWhere(where, Database)?.CopyAs(wrapperType, this);
        }
		...
		/// </param>
		public IEnumerable<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey> ApiKeysWhere(WhereDelegate<ApiKeyColumns> where, OrderBy<ApiKeyColumns> orderBy = null)
        {
            return Wrap<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>(Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.ApiKey.Where(where, orderBy, Database));
        }
		...
		/// between ApiKeyColumns and other values
		/// </param>
		public IEnumerable<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey> TopApiKeysWhere(int count, WhereDelegate<ApiKeyColumns> where)
        {
            return Wrap<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>(Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.ApiKey.Top(count, where, Database));
        }

        public IEnumerable<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey> TopApiKeysWhere(int count, WhereDelegate<ApiKeyColumns> where, OrderBy<ApiKeyColumns> orderBy)
        {
            return Wrap<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>(Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.ApiKey.Top(count, where, orderBy, Database));
        }
        ...
        public async Task BatchQueryApiKeys(int batchSize, WhereDelegate<ApiKeyColumns> where, Action<IEnumerable<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>> batchProcessor)
        {
            await Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.ApiKey.BatchQuery(batchSize, where, (batch) =>
            {
				batchProcessor(Wrap<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>(batch));
            }, Database);
        }
		
        public async Task BatchAllApiKeys(int batchSize, Action<IEnumerable<Bam.Net.CoreServices.ApplicationRegistration.Data.ApiSigningKey>> batchProcessor)
        {
